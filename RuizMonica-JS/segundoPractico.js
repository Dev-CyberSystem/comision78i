...
function mayorEdad() {
  ...
  let añoActual = prompt("Ingrese su año de nacimiento:");
  let añoActualNum = parseInt(añoActual);

  let edad = añoActualNum - añoActualNum ;
  edad <= 18;
  console.log("¿Tu edad es mayor de 18 años? " + edad);
}
 mayorEdad();

// Crea un programa que cuente el número de palabras en una frase proporcionada por el usuario. 
