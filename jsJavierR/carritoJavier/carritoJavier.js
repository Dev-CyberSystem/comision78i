...
const listarProductosFiltrado = document.getElementById("listarProductosFiltrado")
...
function listarProductosFiltrados(array) {
    listarProductosFiltrado.innerHTML = "";

    if (array.length === 0) {
        listarProductosFiltrado.textContent = "No hay productos en el carrito";
    } else {
...
buttonFiltrarProducto.addEventListener("click", (e) => {
  ...
  listarProductosFiltrados(valorFiltrado)
});
